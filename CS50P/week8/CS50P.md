...
Whereas [most countries](https://en.wikipedia.org/wiki/Date_and_time_representation_by_country#Time) use a [24-hour clock](https://en.wikipedia.org/wiki/24-hour_clock), the United States tends to use a [12-hour clock](https://en.wikipedia.org/wiki/12-hour_clock). Accordingly, instead of “09:00 to 17:00”, many Americans would say they work “9:00 AM to 5:00 PM” (or “9 AM to 5 PM”), wherein “AM” is an abbreviation for “**ante meridiem**（中午之前）” and “PM” is an abbreviation for “post meridiem”, wherein “meridiem” means **midday**（中午） (i.e., noon).
...
In a file called `working.py`, implement a function called `convert` that expects a `str` in either of the 12-hour formats below and returns the corresponding `str` in 24-hour format (i.e., `9:00 to 17:00`). Expect that `AM` and `PM` will be **capitalized（大写的）** (with no **periods（句号）** therein) and that there will be a space before each. Assume that these times are representative of actual times, not necessarily 9:00 AM and 5:00 PM specifically.
...
## [Demo](https://cs50.harvard.edu/python/2022/psets/7/working/#demo)

## [Before You Begin](https://cs50.harvard.edu/python/2022/psets/7/working/#before-you-begin)
...
## [How to Test](https://cs50.harvard.edu/python/2022/psets/7/working/#how-to-test)

#### [How to Test](https://cs50.harvard.edu/python/2022/psets/7/working/#how-to-test-workingpy) [`working.py`](https://cs50.harvard.edu/python/2022/psets/7/working/#how-to-test-workingpy)
...
#### [How to Test](https://cs50.harvard.edu/python/2022/psets/7/working/#how-to-test-test_workingpy) [`test_working.py`](https://cs50.harvard.edu/python/2022/psets/7/working/#how-to-test-test_workingpy)
...
## [How to Submit](https://cs50.harvard.edu/python/2022/psets/7/working/#how-to-submit)
